    ...
    <div className="space-y-6">
      ...
      <div className="bg-white rounded-2xl shadow-sm border border-gray-100 p-8 print-area">
        <div className="text-center mb-8 border-b-2 border-blue-600 pb-6">
          <h1 className="text-4xl font-bold text-blue-800 mb-2">{receiptData.collegeName}</h1>
        ...
        <div className="border-2 border-gray-300 rounded-xl p-6">
          ...
          <div className="bg-gradient-to-r from-green-50 to-blue-50 border-2 border-green-300 rounded-xl p-6 mb-6">
            <div className="flex justify-between items-center">
              ...
              <span className="text-3xl font-bold text-green-600">₹{receiptData.feeAmount || '0'}</span>
            </div>
            <p className="text-sm text-gray-600 mt-2 text-center">Amount in Words: {receiptData.feeAmount ? `Rupees ${receiptData.feeAmount} Only` : 'Zero Rupees Only'}</p>
          </div>
