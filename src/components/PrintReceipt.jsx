            ...
            {printType === 'summary' ? (
              ...
              <>
                <div className="text-center mb-6 border-b-2 border-blue-600 pb-4">
                  <h1 className="text-3xl font-bold text-blue-800 mb-2">CAREER MEDICAL COLLEGE</h1>
                  ...
                  <div className="mb-8 bg-green-50 p-6 rounded-lg border-2 border-green-200">
                    ...
                    <div className="grid grid-cols-3 gap-6">
                      ...
                      <div className="text-center">
                        ...
                        <span className="font-bold text-green-900 text-xl">₹{fee.paidAmount?.toLocaleString() || fee.amount?.toLocaleString()}</span>
                      </div>
                    </div>
                  </div>
                )}
